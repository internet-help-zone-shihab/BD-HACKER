...
echo $me "[99]"$me" Join Internet Help Zone"
echo $me "[EXIT]"
echo 
echo 
echo $cy"┌==="$bi"[ xEHx ]"
...
echo $me "===>>> t.me/joinchat/T5NS8RejNbcKTbXyMeA87Q"
fi
...
sleep 2
echo $i" YOUTUBE   :"$i" INTERNET HELP ZONE"
echo $bi"CREATOR :"$i" MOHAMMAD SHIHAB UDDIN"
exit
fi
